...
class Common extends \metadata\Common
{
  ...
  protected const SAML_EC_ANONYMOUS = 'https://refeds.org/category/anonymous';
  protected const SAML_EC_COCOV2 = 'https://refeds.org/category/code-of-conduct/v2';
  protected const SAML_EC_ESI = 'https://myacademicid.org/entity-categories/esi';
  protected const SAML_EC_PERSONALIZED = 'https://refeds.org/category/personalized';
  protected const SAML_EC_PSEUDONYMOUS = 'https://refeds.org/category/pseudonymous';
  protected const SAML_EC_RANDS = 'http://refeds.org/category/research-and-scholarship'; # NOSONAR Should be http://

  protected const HTML_ACTIVE = ' active';
  protected const HTML_SHOW = ' show';
  protected const HTML_SPACER = '  ';
  protected const HTML_TABLE_END = "    </table>\n";
  protected const HTML_TRUE = 'true';
   ...
   * @return void
   */
  protected function showCollapse(
    $title,
    $name,
    $haveSub = true,
    $step = 0,
    ...
    switch ($extra) {
      case 'SSO':
        $extraButton = sprintf(
          '<form action="." method="POST" name="removeSSO%s" style="display: inline;">
        <input type="hidden" name="removeSSO" value="%d">
        <input type="hidden" name="type" value="%s">
        <a href="#" onClick="document.forms.removeSSO%s.submit();"><i class="fas fa-trash"></i></a>%s      </form>',
          $name,
          $entityId,
          $name,
          $name,
      ...
      case 'ContactPersons':
        $extraButton = sprintf(
          '<a href="?edit=%s&Entity=%d&oldEntity=%d"><i class="fa fa-pencil-alt"></i></a>',
          $extra,
          $entityId,
          $oldEntityId
        );
